...
// function handler(message: discordjs.Message, commandString: string, dbo: sqlite3.Database)
...
- delete \`!rocks\` command calls that include your pet rock's name as a parameter
 ...
 * The null returned from this command should be used to stop the command from running.
